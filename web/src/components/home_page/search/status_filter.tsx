...
function StatusFilter() {
  const { statusFilter, setStatusFilter } = useSearchContext();
  ...
  function select(value: Status | null) {
    setStatusFilter(value);
    setOpen(false);
  }

  const summary = statusFilter ?? Strings.filters.statusPlaceholder;
  ...
  return (
    <div className="relative" ref={containerRef}>
      <Button
        variant="text"
        onClick={() => setOpen((o) => !o)}
        aria-label={Strings.filters.statusPlaceholder}
